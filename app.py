...
# --- CONFIG: tu cuenta de Gmail y contraseña de aplicación ---
app.config["MAIL_SERVER"] = "smtp.gmail.com"
app.config["MAIL_PORT"] = 587
app.config["MAIL_USE_TLS"] = True
app.config["MAIL_USE_SSL"] = False
app.config["MAIL_USERNAME"] = "rufina.ventas2025@gmail.com"
app.config["MAIL_PASSWORD"] = "mszx yrky uamn gcsb"  # Contraseña de aplicación
...
def agregar():
    if request.method == "POST":
        ...
        if not nombre or not precio or not stock or not archivo:
